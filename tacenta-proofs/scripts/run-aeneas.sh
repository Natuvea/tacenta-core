...
echo "run-aeneas: from). Commit the source tree before running that command;"
echo "run-aeneas: refresh records HEAD, and --check requires that commit in history."
echo "run-aeneas: Then commit the generated files and manifests. Then, in"
echo "run-aeneas: tacenta-proofs/translation:"
