...
-- Translation/WireT3.lean. Do not edit: `port-session-unit-proofs.sh --check`
...
namespace Tacenta.SessionUnitWireT3

open tacenta_session_unit.tacenta_wire
...
checks a byte pattern (`Tacenta.SessionUnitWireT1.canonicalX25519`). On the thirty-two bytes
...
theorem canonicalKey_bytesOf (k : Std.Array Std.U8 32#usize) :
    Model.Messages.canonicalKey (bytesOf k.val) = Tacenta.SessionUnitWireT1.canonicalX25519 k := by
  ...
  have hall : (List.range' 1 30).all (fun j => (bytesOf k.val)[j]!.toNat == 255)
      = Tacenta.SessionUnitWireT1.allFFFrom k 1 := by
    unfold Tacenta.SessionUnitWireT1.allFFFrom
...
theorem canonicalKey_at (l : List Std.U8) (p : Nat) (k : Std.Array Std.U8 32#usize)
    ...
    Model.Messages.canonicalKey (((bytesOf l).drop p).take 32) = Tacenta.SessionUnitWireT1.canonicalX25519 k := by
...
theorem decode_composite_refines (bytes : Slice Std.U8) :
  ...
  all_goals first
    | (rw [if_neg (by assumption), if_neg (by assumption),
        if_pos (not_eq_true_of_eq_false' (by assumption : ¬ Tacenta.SessionUnitWireT1.canonicalX25519
...
/-- info: 'Tacenta.SessionUnitWireT3.decode_composite_refines' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs in
#print axioms Tacenta.SessionUnitWireT3.decode_composite_refines

/-- info: 'Tacenta.SessionUnitWireT3.decode_message_refines' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs in
#print axioms Tacenta.SessionUnitWireT3.decode_message_refines

end Tacenta.SessionUnitWireT3
