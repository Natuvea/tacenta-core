...
-- Translation/WireInitialT3.lean. Do not edit: `port-session-unit-proofs.sh --check`
...
`Tacenta.SessionUnitWireT3.canonicalKey_at`.
...
namespace Tacenta.SessionUnitWireInitialT3
...
theorem readBe32_of_length (l : List UInt8) (h : 4 ≤ l.length) :
  ...
  Tacenta.SessionUnitWireT3.readBe32_of_length l h
...
open Tacenta.SessionUnitWireT3 tacenta_session_unit.tacenta_wire
...
theorem decode_initial_refines (bytes : Slice Std.U8) :
  ...
  all_goals first
    | (rw [if_pos (by simpa using (by assumption : ¬ Tacenta.SessionUnitWireT1.canonicalX25519
...
def decodeRefusalOf : tacenta_session_unit.tacenta_wire.DecodeError → DecodeRefusal
...
-- new fails here.
/-- info: 'Tacenta.SessionUnitWireInitialT3.decode_initial_refines' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs in
#print axioms Tacenta.SessionUnitWireInitialT3.decode_initial_refines

end Tacenta.SessionUnitWireInitialT3
