...
attribute [-step] Tacenta.UnitSpqrT1.prepare_chains_capacity_loop_new_no_panic
attribute [-step] Tacenta.UnitSpqrT1.prepare_chains_capacity_loop_empty_no_panic
attribute [-step] Tacenta.UnitSpqrT1.prepare_chains_capacity_loop_no_panic
...
theorem prepare_chains_capacity_copies (s : State) (additional : Usize)
    (hcap : Tacenta.UnitSpqrT1.VecRetainTotal)
