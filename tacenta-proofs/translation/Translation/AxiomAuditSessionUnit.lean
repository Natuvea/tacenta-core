...
the PQXDH derivation, the erasure coder and the Braid in this namespace; no
end-to-end Session theorem is claimed here. Every generated declaration and
opaque boundary is visible to the same elaborated-environment audit used by
the smaller units.
-/
