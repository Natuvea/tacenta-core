...
namespace Tacenta.SessionUnitErasureT1
...
def DivCeilTotal : Prop :=
  ∀ a b, b.val ≠ 0 → ∃ r, tacenta_session_unit.core.num.Usize.div_ceil a b = ok r
...
def TruncateTotal : Prop :=
  ∀ (v : alloc.vec.Vec U8) (n : Usize),
    ∃ r, tacenta_session_unit.alloc.vec.Vec.truncate Global v n = ok r
...
/-- info: 'Tacenta.SessionUnitErasureT1.next_chunk_no_panic' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs in
#print axioms Tacenta.SessionUnitErasureT1.next_chunk_no_panic
...
#guard_msgs in
#print axioms Tacenta.SessionUnitErasureT1.message_no_panic
