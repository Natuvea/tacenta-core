...
-- Translation/UnitSpqrT3.lean. Do not edit: `port-session-unit-proofs.sh --check`
...
namespace Tacenta.SessionUnitSpqrT3

open tacenta_session_unit tacenta_session_unit.tacenta_spqr

-- Inserted by port-session-unit-proofs.sh; neither SpqrT3.lean's text nor a
...
theorem skipped_clone_spec (s : Skipped) :
  ...
  Tacenta.SessionUnitSpqrT1.skipped_clone_spec s
...
does. `Tacenta.SessionUnitSpqrT1.ZeroizeTotal` and `Tacenta.SessionUnitSpqrT1.OptionCloneTotal`
