...
namespace Tacenta.SessionUnitBraidT1
...
def EncoderNewTotal : Prop :=
  ∀ (s : Slice U8), ∃ r, tacenta_session_unit.tacenta_erasure.Encoder.new s = ok r

def EncoderNextChunkTotal : Prop :=
  ∀ (e : tacenta_session_unit.tacenta_erasure.Encoder), ∃ r, tacenta_session_unit.tacenta_erasure.Encoder.next_chunk e = ok r

def EncoderCloneTotal : Prop :=
  ∀ (e : tacenta_session_unit.tacenta_erasure.Encoder),
    ∃ r, tacenta_session_unit.tacenta_erasure.Encoder.Insts.CoreCloneClone.clone e = ok r
...
def DecoderNewTotal : Prop :=
  ∀ (n : Usize), ∃ r, tacenta_session_unit.tacenta_erasure.Decoder.new n = ok r
...
def DecoderMessageTotal : Prop :=
  ∀ (d : tacenta_session_unit.tacenta_erasure.Decoder), ∃ r, tacenta_session_unit.tacenta_erasure.Decoder.message d = ok r

def DecoderCloneTotal : Prop :=
  ∀ (d : tacenta_session_unit.tacenta_erasure.Decoder),
    ∃ r, tacenta_session_unit.tacenta_erasure.Decoder.Insts.CoreCloneClone.clone d = ok r
...
def HeaderLenTotal : Prop := ∃ v : Usize, tacenta_session_unit.tacenta_kem.HEADER_LEN = ok v ∧ v.val ≤ 4096
def EkVectorLenTotal : Prop := ∃ v : Usize, tacenta_session_unit.tacenta_kem.EK_VECTOR_LEN = ok v ∧ v.val ≤ 4096
def Ct1LenTotal : Prop := ∃ v : Usize, tacenta_session_unit.tacenta_kem.CT1_LEN = ok v ∧ v.val ≤ 4096
def Ct2LenTotal : Prop := ∃ v : Usize, tacenta_session_unit.tacenta_kem.CT2_LEN = ok v ∧ v.val ≤ 4096
...
def RngTotal {R : Type} (rc : tacenta_session_unit.rand_core_1.RngCore R) : Prop :=
...
def KeyPairGenerateTotal : Prop :=
  ∀ {R : Type} (rc : tacenta_session_unit.rand_core_1.RngCore R) (crc : tacenta_session_unit.rand_core_1.CryptoRng R) (rng : R),
    RngTotal rc → ∃ r, tacenta_session_unit.tacenta_kem.IncrementalKeyPair.generate rc crc rng = ok r
...
def KeyPairHeaderTotal : Prop :=
  ∀ (kp : tacenta_session_unit.tacenta_kem.IncrementalKeyPair),
    ∃ r : alloc.vec.Vec U8, tacenta_session_unit.tacenta_kem.IncrementalKeyPair.header kp = ok r ∧
      r.length ≤ 4096

def KeyPairEkVectorTotal : Prop :=
  ∀ (kp : tacenta_session_unit.tacenta_kem.IncrementalKeyPair),
    ∃ r : alloc.vec.Vec U8, tacenta_session_unit.tacenta_kem.IncrementalKeyPair.ek_vector kp = ok r ∧
      r.length ≤ 4096

def KeyPairDecapsulateTotal : Prop :=
  ∀ (kp : tacenta_session_unit.tacenta_kem.IncrementalKeyPair) (a b : Slice U8),
    ∃ r, tacenta_session_unit.tacenta_kem.IncrementalKeyPair.decapsulate kp a b = ok r

def KeyPairCloneTotal : Prop :=
  ∀ (kp : tacenta_session_unit.tacenta_kem.IncrementalKeyPair),
    ∃ r, tacenta_session_unit.tacenta_kem.IncrementalKeyPair.Insts.CoreCloneClone.clone kp = ok r
...
def Encapsulate1Total : Prop :=
  ∀ {R : Type} (rc : tacenta_session_unit.rand_core_1.RngCore R) (crc : tacenta_session_unit.rand_core_1.CryptoRng R)
    ...
    ∃ r, tacenta_session_unit.tacenta_kem.encapsulate1 rc crc s rng = ok r ∧
      ∀ es (ct1 : alloc.vec.Vec U8) raw,
        r.1 = core.result.Result.Ok (es, ct1, raw) → ct1.length ≤ 4096

def Encapsulate2Total : Prop :=
  ∀ (es : tacenta_session_unit.tacenta_kem.EncapsState) (s : Slice U8),
    ∃ r, tacenta_session_unit.tacenta_kem.encapsulate2 es s = ok r ∧
      ∀ c : alloc.vec.Vec U8, r = core.result.Result.Ok c → c.length ≤ 4096

def EncapsStateCloneTotal : Prop :=
  ∀ (es : tacenta_session_unit.tacenta_kem.EncapsState),
    ∃ r, tacenta_session_unit.tacenta_kem.EncapsState.Insts.CoreCloneClone.clone es = ok r
...
def ValidateEkTotal : Prop :=
  ∀ (a b : Slice U8), ∃ r, tacenta_session_unit.tacenta_kem.validate_ek a b = ok r
...
def HkdfSha256Total : Prop :=
  ∀ (N : Usize) (a b c : Slice U8), N.val ≤ 8160 →
    ∃ r, tacenta_session_unit.tacenta_kdf.hkdf_sha256 N a b c = ok r

def HmacSha256Total : Prop :=
  ∀ (a b : Slice U8), ∃ r, tacenta_session_unit.tacenta_kdf.hmac_sha256 a b = ok r
...
def OptionCloneTotal : Prop :=
  ∀ {T : Type} (inst : core.clone.Clone T) (o : Option T),
    ...
    tacenta_session_unit.core.option.Option.Insts.CoreCloneClone.clone inst o ⦃ fun o' => o' = o ⦄
...
def ZeroizingArrayRoundTrip : Prop :=
  ∀ (N : Usize) (inst : tacenta_session_unit.zeroize.Zeroize (Array U8 N)) (a : Array U8 N),
    ∃ z, tacenta_session_unit.zeroize.Zeroizing.new inst a = ok z ∧
      tacenta_session_unit.zeroize.Zeroizing.Insts.CoreOpsDerefDeref.deref inst z = ok a
...
def ArrayZeroizeTotal : Prop :=
  ∀ (N : Usize) (inst : tacenta_session_unit.zeroize.Zeroize U8) (a : Array U8 N),
    ∃ r, tacenta_session_unit.Array.Insts.ZeroizeZeroize.zeroize (N := N) inst a = ok r
...
def RangeFullIndexTotal : Prop :=
  ∀ (s : Slice U8),
    tacenta_session_unit.core.ops.range.RangeFull.Insts.CoreSliceIndexSliceIndexSliceSlice.index () s = ok s
...
theorem zeroizing_new_spec (hz : ZeroizingArrayRoundTrip) {N : Usize} (a : Array U8 N) :
    tacenta_session_unit.zeroize.Zeroizing.new (tacenta_session_unit.Array.Insts.ZeroizeZeroize N
        (tacenta_session_unit.zeroize.Zeroize.Blanket tacenta_session_unit.U8.Insts.ZeroizeDefaultIsZeroes)) a ⦃ fun z =>
      tacenta_session_unit.zeroize.Zeroizing.Insts.CoreOpsDerefDeref.deref (tacenta_session_unit.Array.Insts.ZeroizeZeroize N
        (tacenta_session_unit.zeroize.Zeroize.Blanket tacenta_session_unit.U8.Insts.ZeroizeDefaultIsZeroes)) z = ok a ⦄ := by
  obtain ⟨z, hz1, hz2⟩ := hz N (tacenta_session_unit.Array.Insts.ZeroizeZeroize N
    (tacenta_session_unit.zeroize.Zeroize.Blanket tacenta_session_unit.U8.Insts.ZeroizeDefaultIsZeroes)) a
  rw [hz1]
  simp [hz2]

/-- Reading the wrapper back, from the fact the wrap left behind. -/
theorem zeroizing_deref_spec {N : Usize} {z : tacenta_session_unit.zeroize.Zeroizing (Array U8 N)} {a : Array U8 N}
    (h : tacenta_session_unit.zeroize.Zeroizing.Insts.CoreOpsDerefDeref.deref (tacenta_session_unit.Array.Insts.ZeroizeZeroize N
        (tacenta_session_unit.zeroize.Zeroize.Blanket tacenta_session_unit.U8.Insts.ZeroizeDefaultIsZeroes)) z = ok a) :
    tacenta_session_unit.zeroize.Zeroizing.Insts.CoreOpsDerefDeref.deref (tacenta_session_unit.Array.Insts.ZeroizeZeroize N
        (tacenta_session_unit.zeroize.Zeroize.Blanket tacenta_session_unit.U8.Insts.ZeroizeDefaultIsZeroes)) z ⦃ fun r => r = a ⦄ := by
  rw [h]; simp

theorem array_zeroize_spec (hzz : ArrayZeroizeTotal) {N : Usize} (a : Array U8 N) :
    tacenta_session_unit.Array.Insts.ZeroizeZeroize.zeroize (N := N)
      (tacenta_session_unit.zeroize.Zeroize.Blanket tacenta_session_unit.U8.Insts.ZeroizeDefaultIsZeroes) a ⦃ fun _ => True ⦄ := by
  obtain ⟨r, hr⟩ := hzz N (tacenta_session_unit.zeroize.Zeroize.Blanket tacenta_session_unit.U8.Insts.ZeroizeDefaultIsZeroes) a
  rw [hr]; simp

theorem index_full_spec (hrf : RangeFullIndexTotal) {N : Usize} (a : Array U8 N) :
    core.array.Array.index (core.ops.index.IndexSlice
      (tacenta_session_unit.core.ops.range.RangeFull.Insts.CoreSliceIndexSliceIndexSliceSlice U8)) a ()
...
theorem Msg.with_no_panic (epoch : U64) (ty : MsgType) (chunk : Option tacenta_session_unit.tacenta_erasure.Chunk) :
...
theorem Braid.step_send_no_panic {R : Type} (rc : tacenta_session_unit.rand_core_1.RngCore R)
    (crc : tacenta_session_unit.rand_core_1.CryptoRng R) (hrng : RngTotal rc) (hgen : KeyPairGenerateTotal)
...
theorem Braid.send_no_panic {R : Type} (rc : tacenta_session_unit.rand_core_1.RngCore R)
    (crc : tacenta_session_unit.rand_core_1.CryptoRng R) (hrng : RngTotal rc)
...
theorem finish_encaps_no_panic (hencaps2 : Encapsulate2Total) (hmac : HmacSha256Total)
    (henew : EncoderNewTotal) (epoch : U64) (auth : Auth) (encaps : tacenta_session_unit.tacenta_kem.EncapsState)
...
/--
info: 'Tacenta.SessionUnitBraidT1.Braid.send_no_panic' depends on axioms: [propext,
 Classical.choice,
 Quot.sound,
...
-/
#guard_msgs in
#print axioms Tacenta.SessionUnitBraidT1.Braid.send_no_panic

/--
info: 'Tacenta.SessionUnitBraidT1.Braid.receive_no_panic' depends on axioms: [propext,
 Classical.choice,
 Quot.sound,
 tacenta_session_unit.tacenta_kdf.hkdf_sha256,
 tacenta_session_unit.tacenta_kdf.hmac_sha256,
...
-/
#guard_msgs in
#print axioms Tacenta.SessionUnitBraidT1.Braid.receive_no_panic

end Tacenta.SessionUnitBraidT1
