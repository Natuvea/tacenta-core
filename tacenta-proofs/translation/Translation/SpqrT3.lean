...
attribute [-step] Tacenta.SpqrT1.prepare_chains_capacity_loop_new_no_panic
attribute [-step] Tacenta.SpqrT1.prepare_chains_capacity_loop_empty_no_panic
attribute [-step] Tacenta.SpqrT1.prepare_chains_capacity_loop_no_panic
...
theorem prepare_chains_capacity_copies (s : State) (additional : Usize)
    (hcap : Tacenta.SpqrT1.VecRetainTotal)
...
`Tacenta.SpqrT1.ZeroizeTotal` and `Tacenta.SpqrT1.OptionCloneTotal`
