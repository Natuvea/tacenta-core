...
The session runs the agreement first, because its epoch and output are inputs
to the Triple Ratchet operation. On a send it then runs the Triple Ratchet on a
