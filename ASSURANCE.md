...
5. **Model and formats:**
   - the model's counter ceilings: done for the classical and sparse ratchets, and `Model.Braid` still counts epochs in `Nat`;
