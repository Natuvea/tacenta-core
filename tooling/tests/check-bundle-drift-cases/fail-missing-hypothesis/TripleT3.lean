-- expect: MISSING from the clause
-- The sparse receive clause drops the skip-room bound the leaf theorem
-- requires. Nothing in a Lean build notices; the multiset comparison
-- does.
