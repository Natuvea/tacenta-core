...
Rust-backed `ratchet_private` mismatch, boundary-neighbour mutations, or
...
- An invalid vector's `refusal` is `wrong-version`, `short-or-malformed`,
  ...
  `unanswered-initiator-is-also-responder` is generated by Lean from a
  responder fixture carrying the pending initial from the unanswered initiator
  fixture. The `ratchet-private-does-not-match-dhs-pub` vector is appended by
